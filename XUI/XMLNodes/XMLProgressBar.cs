...
namespace IngameScript
{
	...
	{
		public class XMLProgressBar : XMLTree
		{
			IRenderBox emptyBar;
			...
			public XMLProgressBar() : this(0f)
			{
			}

			public XMLProgressBar(float fillLevel) : this(fillLevel, false)
			{
			}

			public XMLProgressBar(float fillLevel, bool selectable) : base()
			{
				Type = "progressbar";
